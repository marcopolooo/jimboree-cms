  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Add Extracuricullar</li>
        </ol>
      </section>
      <!-- Main content -->
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="<?php echo base_url('master-data/extracuricullar/store'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-lg-2" for="nama">Nama Extracuricullar</label>
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="class" placeholder="Enter Extracuricullar" name="jenis_extracuricullar" required><br>
                        </div>
                      </div>
                      <div class="form-group">
