<?php $this->load->view('layouts/header.php'); ?>
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Add School Improvement
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">Add School Improvement</li>
        </ol>
      </section>
          ...
          <div class="row">
            ...
            ?>
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="<?php echo base_url('master-data/schoolimprovement/store'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-lg-2" for="desc">Desc</label>
                        <div class="col-lg-10">
                          <textarea class="textarea" name="desc" id="desc" required></textarea><br><br>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-2" for="desc2">Desc 2</label>
                        <div class="col-lg-10">
                          <textarea class="textarea" name="desc2" id="desc2" required></textarea><br><br>
                        </div>
                      </div>
                      <div class="form-group">
