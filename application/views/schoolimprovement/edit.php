          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="<?php echo base_url('master-data/schoolimprovement/update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                      <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $data[0]['id']; ?>">
                        <label class="col-lg-2" for="desc">Desc</label>
                        <div class="col-lg-10">
                          <textarea class="textarea" name="desc" id="desc" required><?php echo $data[0]['desc']?></textarea><br><br>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-2" for="desc">Desc 2</label>
                        <div class="col-lg-10">
                          <textarea class="textarea" name="desc2" id="desc" required><?php echo $data[0]['desc2']?></textarea><br><br>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <div class="input-group">
                              ...
                              <input type="text" name="input-news-image" value="<?php echo base_url() . explode("jimboree-cms/", $data[0]['image'])[1]; ?>" class="form-control" readonly>
                          </div>
                      ...
                      <a href="<?php echo base_url('master-data/schoolimprovement'); ?>" class="btn btn-danger">Cancel</a>
                    </div>
                  </form>
              </div>
            </div>
