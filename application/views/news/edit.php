          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="<?php echo base_url('master-data/news/update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-lg-2" for="title">Title</label>
                        <div class="col-lg-10">
                          <input type="hidden" class="form-control" id="title" name="id" value="<?php echo $data[0]['id']; ?>" required>
                          <input type="text" class="form-control" id="title" placeholder="Enter News" name="title" value="<?php echo $data[0]['title']; ?>" required><br>
                        </div>
                      </div>
                      <div class="form-group">
